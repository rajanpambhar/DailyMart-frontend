          ...
          <nav className="hidden lg:flex items-center gap-1 absolute left-1/2 -translate-x-1/2">
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-300 text-gray-300 hover:text-white hover:bg-white/5 flex items-center gap-1"
              >
                All Products
              ...
              {isCategoryDropdownOpen && (
                <div
                  onMouseEnter={() => setIsCategoryDropdownOpen(true)}
                  onMouseLeave={() => setIsCategoryDropdownOpen(false)}
                  className="absolute top-full left-0 mt-1 w-56 bg-dark-800 border border-dark-600 rounded-xl shadow-2xl z-50 overflow-hidden animate-slide-down"
                >
                  <div className="p-2">
                    <NavLink
                      to="/products"
                      className={({ isActive }) =>
                        `block px-4 py-2.5 text-sm font-medium rounded-lg transition-colors ${isActive
                    ...
                    <div className="my-2 border-t border-dark-600"></div>
          ...
          <nav className="lg:hidden py-4 border-t border-white/10 animate-slide-down bg-dark-900/95 backdrop-blur-xl absolute top-16 left-0 w-full shadow-2xl">
            <div className="container">
              ...
              <div className="border-t border-white/10 pt-3">
                <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-2 px-2">More Categories</p>
