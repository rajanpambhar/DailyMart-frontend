  ...
  return (
    <div className="min-h-screen bg-transparent pb-12 animate-fade-in">
      ...
      <div className="relative overflow-hidden text-white">
        <div className="absolute inset-0 bg-gradient-to-r from-primary-600/10 to-secondary-600/10 z-0 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20 pb-24 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-500/10 text-primary-300 border border-primary-500/20 mb-6 backdrop-blur-sm animate-fade-in-up">
                <Zap className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                <span className="text-sm font-semibold tracking-wide uppercase">Limited Time Offer</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-primary-100 to-secondary-200 animate-fade-in-up delay-100">
                Special Promotion
            </h1>
            
            <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10 animate-fade-in-up delay-200 font-light">
            ...
            <div className="flex justify-center gap-4 mb-12 animate-fade-in-up delay-300">
                <div className="flex flex-col items-center p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl min-w-[100px]">
                ...
                <div className="text-4xl font-bold pt-2 text-white/50">:</div>
                <div className="flex flex-col items-center p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl min-w-[100px]">
            ...
            <button 
                ...
                className="group relative px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white font-bold rounded-full overflow-hidden transition-all duration-300 shadow-[0_0_20px_rgba(51,204,255,0.3)] hover:shadow-[0_0_30px_rgba(51,204,255,0.5)] animate-fade-in-up delay-500 border border-primary-500/20"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-6 hover:-translate-y-1 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-full bg-blue-500/10 flex items-center justify-center mb-4 group-hover:bg-blue-500/20 transition-colors border border-blue-500/20">
            ...
            {/* Deal 2 */}
            <div className="glass-card p-6 hover:-translate-y-1 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-full bg-green-500/10 flex items-center justify-center mb-4 group-hover:bg-green-500/20 transition-colors border border-green-500/20">
            ...
            {/* Deal 3 */}
            <div className="glass-card p-6 hover:-translate-y-1 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-full bg-purple-500/10 flex items-center justify-center mb-4 group-hover:bg-purple-500/20 transition-colors border border-purple-500/20">
      ...
      <div id="flash-sale" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/products" className="text-primary-400 hover:text-primary-300 font-medium flex items-center gap-1 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="relative rounded-3xl overflow-hidden glass-card p-8 md:p-12 border border-white/10">
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/30 to-purple-600/30 z-0"></div>
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left">
                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
                        Weekend Super Sale
                    </h3>
                    <p className="text-indigo-100 text-lg max-w-xl font-light">
                        Get an extra 20% off on all electronics this weekend. Use code <span className="font-mono font-bold bg-white/10 border border-white/20 px-2 py-1 rounded text-white">WEEKEND20</span> at checkout.
                    </p>
                </div>
                <div className="flex-shrink-0">
                    <button className="bg-white text-indigo-900 hover:bg-indigo-50 font-bold py-3 px-8 rounded-xl shadow-lg transition-colors flex items-center gap-2">
